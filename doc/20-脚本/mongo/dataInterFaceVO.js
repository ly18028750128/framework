...
db.getCollection("dataInterFaceVO").insert([ {
    ...
    authMethod: "BYUSERPERMISSION",
    createdOrUpdateBy: NumberLong("1"),
    createdOrUpdateTime: ISODate("2023-08-16T06:58:38.004Z"),
    createdOrUpdateUserName: "admin",
