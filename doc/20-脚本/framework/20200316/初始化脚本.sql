...
-- 3:增加授权的操作权限
INSERT INTO `framework`.`t_framework_resource`(`resource_id`, `resource_code`, `resource_name`, `resource_path`, `method`, `belong_microservice`, `create_by`, `create_date`, `update_by`, `update_date`)
VALUES (-1000, 'saveOrUpdateRoles', '操作权限授权', '/admin/role/', 'BYUSERPERMISSION', 'common-service', 'admin', '2020-03-16 10:47:52', 'admin', '2020-03-16 10:47:52');
INSERT INTO `framework`.`t_framework_resource`(`resource_id`, `resource_code`, `resource_name`, `resource_path`, `method`, `belong_microservice`, `create_by`, `create_date`, `update_by`, `update_date`)
VALUES (-1001, 'saveOrUpdateUser', '用户角色授权', '/admin/user', 'BYUSERPERMISSION', 'common-service', 'admin', '2020-03-16 10:47:52', 'admin', '2020-03-16 10:47:52');
...
INSERT INTO `framework`.`t_frame_role_data_interface`( `role_id`, `data_interface_id`, `belong_microservice`, `data_interface_name`) VALUES ( 1, 'fbf2e7c0ec6c91d9041ccd92509ce309', 'COMMONSERVICE', '按用户ID查询用户的角色列表');