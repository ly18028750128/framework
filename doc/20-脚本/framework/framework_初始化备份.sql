...
DROP TABLE IF EXISTS `t_email_sender_config`;
...
DROP TABLE IF EXISTS `t_frame_menu_old`;
...
DROP PROCEDURE IF EXISTS `up_temp_dic_create`;
...
COMMIT;
BEGIN;
LOCK TABLES `t_frame_export_template` WRITE;
DELETE FROM `t_frame_export_template`;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `t_frame_import_export_task` WRITE;
DELETE FROM `t_frame_import_export_task`;
UNLOCK TABLES;
COMMIT;
BEGIN;
...
INSERT INTO `t_frame_user_role` (`user_role_id`,`user_id`,`role_id`,`validator_start`,`validator_end`,`create_by`,`create_date`,`update_by`,`update_date`) VALUES (48, 1, 1, '2023-08-16 19:12:15', '2024-08-16 19:12:15', 'admin', '2020-01-29 16:48:11', 'admin', '2023-08-06 16:33:03')
;
UNLOCK TABLES;
COMMIT;
BEGIN;
...
INSERT INTO `t_microservice_register` (`microservice_id`,`microservice_name`,`create_by`,`create_date`,`update_by`,`update_date`) VALUES (6, 'common-service', 'admin', '2023-03-09 19:23:10', 'admin', '2023-03-09 19:23:10'),(9, 'spring-gateway', 'admin', '2023-03-06 18:08:42', 'admin', '2023-03-06 18:08:42')
;
UNLOCK TABLES;
COMMIT;
BEGIN;
