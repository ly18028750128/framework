...
Backup Time: 2023-08-16 18:39:04
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='数据权限列表\r\n角色类型为功能权限之外的权限统一为功能权限';
...
INSERT INTO `template_framework`.`t_frame_user_role` (`user_role_id`,`user_id`,`role_id`,`validator_start`,`validator_end`,`create_by`,`create_date`,`update_by`,`update_date`) VALUES (47, 1, 1, '2020-01-17 03:25:12', '2020-02-01 03:25:16', 'admin', NULL, 'admin', NULL)
;
UNLOCK TABLES;
COMMIT;
BEGIN;
