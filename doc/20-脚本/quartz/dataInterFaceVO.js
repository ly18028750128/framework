/*
 ...
 Source Server         : 309-47.242.46.104
 Source Server Type    : MongoDB
 Source Server Version : 40400
 Source Host           : 47.242.46.104:10003
...
db.getCollection("dataInterFaceVO").insert([ {
    ...
    microServiceName: "COMMON-SERVICE",
    authMethod: "ALLSYSTEMUSER",
    createdOrUpdateTime: ISODate("2020-06-08T05:08:08.902Z"),
    createdOrUpdateBy: NumberLong("1"),
    createdOrUpdateUserName: "admin",
    status: NumberInt("1"),
    _class: "org.cloud.mongo.DataInterFaceVO",
...
db.getCollection("dataInterFaceVO").insert([ {
    ...
    microServiceName: "General",
    authMethod: "ALLSYSTEMUSER",
    createdOrUpdateTime: ISODate("2020-08-25T13:58:35.892Z"),
    createdOrUpdateBy: NumberLong("1"),
    createdOrUpdateUserName: "admin",
...
db.getCollection("dataInterFaceVO").insert([ {
    ...
    authMethod: "ALLSYSTEMUSER",
    createdOrUpdateTime: ISODate("2020-04-10T03:29:49.836Z"),
    createdOrUpdateBy: NumberLong("1"),
    createdOrUpdateUserName: "admin",
...
db.getCollection("dataInterFaceVO").insert([ {
    ...
    microServiceName: "HEYIGIS",
    authMethod: "ALLSYSTEMUSER",
    createdOrUpdateTime: ISODate("2020-04-23T13:39:19.644Z"),
    createdOrUpdateBy: NumberLong("1"),
    createdOrUpdateUserName: "admin",
...
db.getCollection("dataInterFaceVO").insert([ {
    ...
    authMethod: "BYUSERPERMISSION",
    createdOrUpdateTime: ISODate("2020-08-20T13:38:13.974Z"),
    createdOrUpdateBy: NumberLong("1"),
    createdOrUpdateUserName: "admin",
    status: NumberInt("1"),
    _class: "org.cloud.mongo.DataInterFaceVO",
