/*
 ...
 Source Server Version : 100409
 Source Host           : 172.16.4.23:10002
 Source Schema         : quartz

 Target Server Type    : MySQL
 Target Server Version : 100409
 File Encoding         : 65001

 Date: 17/02/2020 14:15:05
*/
...
CREATE TABLE `qrtz_cron_triggers`  (
  ...
  `TRIGGER_NAME` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `TRIGGER_GROUP` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `CRON_EXPRESSION` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `TIME_ZONE_ID` varchar(80) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`SCHED_NAME`, `TRIGGER_NAME`, `TRIGGER_GROUP`) USING BTREE,
...
CREATE TABLE `qrtz_fired_triggers`  (
  ...
  `JOB_NAME` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  `JOB_GROUP` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  `IS_NONCONCURRENT` varchar(1) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  `REQUESTS_RECOVERY` varchar(1) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `qrtz_job_details`  (
  ...
  `DESCRIPTION` varchar(250) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `qrtz_simprop_triggers`  (
  ...
  `TRIGGER_NAME` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `TRIGGER_GROUP` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `STR_PROP_1` varchar(512) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  `STR_PROP_2` varchar(512) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  `STR_PROP_3` varchar(512) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  ...
  `BOOL_PROP_1` varchar(1) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  `BOOL_PROP_2` varchar(1) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`SCHED_NAME`, `TRIGGER_NAME`, `TRIGGER_GROUP`) USING BTREE,
...
CREATE TABLE `qrtz_triggers`  (
  ...
  `CALENDAR_NAME` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NULL DEFAULT NULL,
