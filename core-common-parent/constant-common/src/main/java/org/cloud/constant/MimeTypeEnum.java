...
public enum MimeTypeEnum {
     ...
     * @return 枚举类
     */
    public static MimeTypeEnum byExtension(String extension) {
        return Arrays.stream(MimeTypeEnum.values()).filter(value -> value.extension.equals(extension)).findFirst().orElse(BIN);
    }
     ...
     * @return 枚举类
     */
    public static MimeTypeEnum byFileName(String filename) {
        ...
        return byExtension(filename.substring(lastIndex + 1));
    }
    ...
    public static String contentType(String fileType) {
        MimeTypeEnum mimeTypeEnum = MimeTypeEnum.byExtension(fileType);
    ...
    public static String contentTypeByFileName(String fileName) {
        return byFileName(fileName).mimeType;
    }
