package com.unknow.first.utils;


import static org.apache.poi.poifs.macros.Module.ModuleType.Document;

import com.unknow.first.poi.WordParagraphStyleVO;
import com.unknow.first.poi.WordPictureVO;
import com.unknow.first.poi.WordTableCellVO;
import com.unknow.first.poi.WordTableHeaderVO;
import com.unknow.first.poi.WordTableVO;
import com.unknow.first.poi.WordTextVO;
...
public final class WordUtils {
    ...
    public void insertPicture(final CTBookmark bookmark, final XWPFParagraph xwpfParagraph, WordPictureVO wordPictureVO) throws Exception {
        ...
        try {
            run.addPicture(inputStreamPic, Workbook.PICTURE_TYPE_PNG, "", Units.toEMU(wordPictureVO.getWidth()), Units.toEMU(wordPictureVO.getHeight()));
