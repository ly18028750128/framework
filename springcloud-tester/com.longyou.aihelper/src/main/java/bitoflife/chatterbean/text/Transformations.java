...
import com.longyou.aihelper.util.ChineseSegmenter;
...
public class Transformations {
  ...
  */
  ...
  /**
   * 开启大写， Turns the entry to UPPERCASE, takes sequences of non-alphanumeric characters out of it (replacing them with a single whitespace)
   * and sees that the entry is trimmed off leading and trailing whitespaces.
   */
