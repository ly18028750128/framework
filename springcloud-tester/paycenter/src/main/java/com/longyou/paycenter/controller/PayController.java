...
public class PayController {
    ...
    public ResponseResult unifiedorder(@PathVariable("payPlatformIndex") Integer payPlatformIndex, @RequestBody Map<String, Object> params) throws Exception {
    ...
    public ResponseResult refund(@PathVariable("payPlatformIndex") Integer payPlatformIndex, @RequestBody Map<String, Object> params) throws Exception {
        PayAppConfig payAppConfig = payAppConfigList.getPlatformList().get(payPlatformIndex);
        PayService payService = SpringContextUtil.getBean(PayService._PAY_SERVICE_PRFIX + payAppConfig.getType(), PayService.class);
    ...
    public ResponseResult receiver(@PathVariable("payPlatformIndex") int payPlatformIndex, @RequestBody Map<String, Object> payResult, HttpServletRequest request, HttpServletResponse response) throws Exception {
        PayAppConfig payAppConfig = payAppConfigList.getPlatformList().get(payPlatformIndex);
        PayService payService = SpringContextUtil.getBean(PayService._PAY_SERVICE_PRFIX + payAppConfig.getType(), PayService.class);
    ...
    public ResponseResult refundCallback(@PathVariable("payPlatformIndex") int payPlatformIndex, @RequestBody Map<String, Object> refundResult, HttpServletRequest request, HttpServletResponse response) throws Exception {
//        PayAppConfig payAppConfig = payAppConfigList.getPlatformList().get(payPlatformIndex);
//        PayService payService = SpringContextUtil.getBean(PayService._PAY_SERVICE_PRFIX + payAppConfig.getType(), PayService.class);
